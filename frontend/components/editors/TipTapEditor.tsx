	...
	return (
		<button
			...
			className={cn(
				...
				active
					? "border-[#94aaff]/50 bg-[#94aaff]/15 text-[#c7d4ff]"
...
export function TipTapEditor({
	...
	const editor = useEditor({
		...
		editorProps: {
			attributes: {
				class:
					"min-h-[260px] max-h-[55vh] overflow-y-auto rounded-b-xl bg-[#0b1328] px-4 py-4 text-sm leading-7 text-[#dee5ff] focus:outline-none",
			},
		},
	...
	return (
		<div className={cn("overflow-hidden rounded-xl border border-zinc-800", className)}>
			<div className="flex flex-wrap items-center gap-2 border-b border-zinc-800 bg-[#111b33] px-3 py-2">
				<ToolbarButton
					ariaLabel="Undo"
