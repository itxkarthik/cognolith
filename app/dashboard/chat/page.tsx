    ...
    <div className="space-y-5">
      <section className="rounded-2xl border border-zinc-800 bg-zinc-900/70 p-6 backdrop-blur">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <h1 className="mt-2 text-2xl font-semibold text-zinc-100">Chat Sessions</h1>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-zinc-600 bg-zinc-100 px-3 py-2 text-sm font-medium text-zinc-900 transition hover:bg-zinc-200 disabled:cursor-not-allowed disabled:opacity-60"
          >
      ...
      <section className="space-y-2">
        {isLoading ? (
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/70 p-6 text-sm text-zinc-400 backdrop-blur">
          ...
          sessions.map((session) => {
            ...
            return (
              <Link
                ...
                className="block rounded-xl border border-zinc-800 bg-zinc-900/70 p-4 backdrop-blur transition hover:border-zinc-600"
              >
